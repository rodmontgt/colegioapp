                                            ...
                                            <div class="col-xl-4 col-md-6 results">
                                                  <div class="card-box widget-user ui-block list">
                                                    ...
                                                    <div class="wid-u-info">
                                                        <a href="<?php echo base_url();?>teacher/view_marks/<?php echo $row['student_id'];?>/" class="h6 author-name"><h5 class="mt-0 m-b-5"> <?php echo $this->crud_model->get_name('student', $row['student_id']);?></h5></a>
                                    ...
                                    <?php $students = $this->db->get_where('enroll' , array('class_id'=> $class_id , 'section_id' => $row['section_id'] , 'year' => $running_year))->result_array();
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                  <div class="card-box widget-user ui-block list">
                                                    ...
                                                    <div class="wid-u-info">
                                                        <a href="<?php echo base_url();?>teacher/view_marks/<?php echo $row['student_id'];?>/" class="h6 author-name"><h5 class="mt-0 m-b-5"> <?php echo $this->crud_model->get_name('student', $row2['student_id']);?></h5></a>
