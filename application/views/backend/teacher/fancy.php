            ...
            <div class="author-page author vcard inline-items more">
                ...
                <a href="#" class="author-name fn">
                    <div class="author-title">
                        <?php echo $this->crud_model->get_name('teacher', $this->session->userdata('login_user_id'));?> <svg class="olymp-dropdown-arrow-icon">
                    </div>
        ...
        <ul class="nav nav-tabs mobile-app-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#notification" role="tab">
                    <div class="control-icon has-items">
                        <i class="picons-thin-icon-thin-0543_world_earth_worldwide_location_travel"></i>
                        <?php if($fancy_count->num_rows() > 0):?><div class="label-avatar bg-success"> <?php echo $fancy_count->num_rows();?> <?php endif;?></div>
                    </div>
                </a>
            </li>
            <li class="nav-item">
