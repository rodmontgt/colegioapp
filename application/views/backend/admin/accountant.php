                                                            ...
                                                            <div class="card-box widget-user ui-block list">
                                                                <div class="more" style="float:right;">
                                                                        ...
                                                                        <ul class="more-dropdown">
                                                                            ...
                                                                            <li><a onClick="return confirm('<?php echo get_phrase('confirm_delete');?>')" href="<?php echo base_url();?>admin/accountant/delete/<?php echo $row['accountant_id'];?>"><?php echo get_phrase('delete');?></a></li>
                                                                        </ul>
                                                                    </div>
                                                                <div>
                                                                    ...
                                                                    <div class="wid-u-info">
                                                                        <a href="<?php echo base_url();?>admin/accountant_profile/<?php echo $row['accountant_id'];?>/" class="h6 author-name"><h5 class="mt-0 m-b-5"> <?php echo $this->crud_model->get_name('accountant', $row['accountant_id']);?></h5></a>
