            ...
            <div class="post__author author vcard inline-items">
                ...
                <div class="more">
                    ...
                    <ul class="more-dropdown">
                        ...
                        <li><a onClick="return confirm('<?php echo get_phrase('confirm_delete');?>')"  href="<?php echo base_url();?>admin/news/delete2/<?php echo $wall['news_code'];?>"><?php echo get_phrase('delete');?></a></li>
                    </ul>
                </div>
            </div><hr>
